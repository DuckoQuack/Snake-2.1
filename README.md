In order for this to work, you will need Python 3 or above, you will also need to download pygame. To download pygame, open command prompt and type "pip install pygame".
